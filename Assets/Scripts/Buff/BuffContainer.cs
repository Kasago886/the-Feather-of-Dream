...
public class BuffContainer
{
    ...
    public static Dictionary<string, Type> buffDictionary = new Dictionary<string, Type>
    {
        ...
        {"才华",typeof(Talent) },//使对象韧性乘5，持续29.7s
        ...
        {"萎靡",typeof(Lethargic) },//如果对象当前的力量不低于初始力量的5%，则使对象降低10%的力量，最高不超过6点力量，持续16s
        {"脆弱",typeof(Fragile) },//如果对象当前的力量不低于初始韧性的5%,使对象降低10%的韧性，最高不超过20点韧性，持续16s
        ...
        {"灼伤",typeof(Scorch) },//使对象每0.1秒扣除0.05滴血，持续12s，buff持续期间如果被施加新的灼伤则持续时间延长6s
        ...
        {"裂隙",typeof(Fissure) },//触发条件：对象的伤痕抵抗小于5并且对象的伤痕层数大于13，效果：使对象在n次受击后，受到n*伤痕层数*伤痕伤害*误解级数的伤害，持续时间无限至发挥作用
        ...
        {"梦隆",typeof (ExperimentEffectBuff4) },//召唤两个污染克隆体
